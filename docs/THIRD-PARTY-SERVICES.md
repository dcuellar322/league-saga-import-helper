...
The helper opens ESPN in a separate browser session and makes ESPN fantasy-football requests on
your device. You must use only an account and league that you are authorized to access. ESPN's and
Disney's terms and privacy policies apply to your ESPN account and your use of their services.
...
The packaged helper can use GitHub's public releases service to check for updates. GitHub receives
the ordinary network and device information that is part of that request. GitHub's terms and
privacy policy apply to its service.
